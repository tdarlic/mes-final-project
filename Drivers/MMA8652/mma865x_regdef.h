 ...
 */
#ifndef MMA865x_REGDEF_H_
#define MMA865x_REGDEF_H_

#include <stdint.h>

/**
 * @file  mma865x_regdef.h
 * @brief The file contains register definitions & bitmaps for MMA865x 3-axis digital accelerometer.
...
#define MMA865x_I2C_ADDRESS_WRITE   (0x3A)  /* MMA865x I2C Slave Address. */
#define MMA865x_I2C_ADDRESS_READ    (0x3B)  /* MMA865x I2C Slave Address. */
