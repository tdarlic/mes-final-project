 ...
 *      INCLUDES
 *********************/
#include <lvgl-local/lv_music/lv_demo_music_main.h>
#if LV_USE_DEMO_MUSIC

#include <lvgl-local/lv_music/lv_demo_music_list.h>
#include <lvgl-local/lv_music/assets/spectrum_1.h>
#include <lvgl-local/lv_music/assets/spectrum_2.h>
#include <lvgl-local/lv_music/assets/spectrum_3.h>
